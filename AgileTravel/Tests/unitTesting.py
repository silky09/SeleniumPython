...
class FormTest(unittest.TestCase):
    ...
    def test_login_valid(self):
        ...
        # Destination
        Origin_From = Select(
            driver.find_element(By.XPATH, '//*[@id="container"]/form/table[1]/tbody/tr[2]/td[2]/select'))
        ...
        Expiry_in_Date = Select(
            driver.find_element(By.XPATH, '//*[@id="payment-form"]/table/tbody/tr[4]/td[2]/select[1]'))
        Expiry_in_Date.select_by_visible_text("09")

        Expiry_in_Month = Select(
            driver.find_element(By.XPATH, '//*[@id="payment-form"]/table/tbody/tr[4]/td[2]/select[2]'))
